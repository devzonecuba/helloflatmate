...
// Returns the private 'App\Repository\ClienteRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ClienteRepository.php';

return $this->privates['App\Repository\ClienteRepository'] = new \App\Repository\ClienteRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
