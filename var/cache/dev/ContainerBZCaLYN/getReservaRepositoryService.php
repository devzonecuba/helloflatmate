...
// Returns the private 'App\Repository\ReservaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ReservaRepository.php';

return $this->privates['App\Repository\ReservaRepository'] = new \App\Repository\ReservaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
