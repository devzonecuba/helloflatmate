...
// Returns the private 'App\Repository\ServicioadicionalRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ServicioadicionalRepository.php';

return $this->privates['App\Repository\ServicioadicionalRepository'] = new \App\Repository\ServicioadicionalRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
