...
// Returns the private 'App\Repository\CamaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CamaRepository.php';

return $this->privates['App\Repository\CamaRepository'] = new \App\Repository\CamaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
