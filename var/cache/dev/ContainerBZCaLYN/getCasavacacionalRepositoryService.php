...
// Returns the private 'App\Repository\CasavacacionalRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CasavacacionalRepository.php';

return $this->privates['App\Repository\CasavacacionalRepository'] = new \App\Repository\CasavacacionalRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
