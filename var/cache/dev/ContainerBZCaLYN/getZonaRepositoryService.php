...
// Returns the private 'App\Repository\ZonaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ZonaRepository.php';

return $this->privates['App\Repository\ZonaRepository'] = new \App\Repository\ZonaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
