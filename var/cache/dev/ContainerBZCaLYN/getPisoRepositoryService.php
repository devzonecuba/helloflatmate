...
// Returns the private 'App\Repository\PisoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\PisoRepository.php';

return $this->privates['App\Repository\PisoRepository'] = new \App\Repository\PisoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
