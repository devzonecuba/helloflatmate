...
// Returns the private 'App\Repository\CentrosaludRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CentrosaludRepository.php';

return $this->privates['App\Repository\CentrosaludRepository'] = new \App\Repository\CentrosaludRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
