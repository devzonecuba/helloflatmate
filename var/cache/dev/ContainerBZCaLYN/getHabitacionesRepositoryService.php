...
// Returns the private 'App\Repository\HabitacionesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\HabitacionesRepository.php';

return $this->privates['App\Repository\HabitacionesRepository'] = new \App\Repository\HabitacionesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
