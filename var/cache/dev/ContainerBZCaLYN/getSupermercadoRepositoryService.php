...
// Returns the private 'App\Repository\SupermercadoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\SupermercadoRepository.php';

return $this->privates['App\Repository\SupermercadoRepository'] = new \App\Repository\SupermercadoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
