...
// Returns the private 'App\Repository\UniversidadRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\UniversidadRepository.php';

return $this->privates['App\Repository\UniversidadRepository'] = new \App\Repository\UniversidadRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
